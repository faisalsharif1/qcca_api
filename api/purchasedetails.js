...
module.exports = (function () {
    ...
    router.post('/api/purchasedetails', [body().isArray(),
        body('*.Id', 'Id is necessary').exists(),
        body('*.PurchaseId', 'PurchaseId is necessary').exists(),
        ...
        connection.query('CALL purchasedetails_Process(?)', [JSON.stringify(req.body)], function (err, results, fields) {
            if (err) {
                res.status(500).json({
