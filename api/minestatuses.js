...
module.exports = (function () {
    ...
    router.post('/api/minestatuses', [body().isArray(),
        body('*.Id', 'Id is necessary').exists(),
        body('*.MineStatus', 'MineStatus is necessary').exists(),
        ...
        connection.query('CALL minestatuses_Process(?)', [JSON.stringify(req.body)], function (err, results, fields) {
            if (err) {
                res.status(500).json({
