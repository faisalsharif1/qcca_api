...
module.exports = (function () {
    ...
    router.post('/api/transactionhistories', [body().isArray(),
        ...
        body('*.EditedByUserId', 'EditedByUserId is necessary').exists(),
        body('*.TransactionTypeId', 'TransactionTypeId is necessary').exists(),
        ...
        connection.query('CALL transactionshistories_Process(?)', [JSON.stringify(req.body)], function (err, results, fields) {
            if (err) {
                res.status(500).json({
