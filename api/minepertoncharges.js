...
module.exports = (function () {
    ...
    router.post('/api/minepertoncharges', [body().isArray(),
        ...
        connection.query('CALL mines_pertoncharges_Process(?)', [JSON.stringify(req.body)], function (err, results, fields) {
            if (err) {
                res.status(500).json({
