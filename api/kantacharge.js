...
module.exports = (function () {
    ...
    router.post('/api/kantacharge', [body().isArray(),
        body('*.Id', 'Id is necessary').exists(),
        body('*.CustomerTypeId', 'CustomerTypeId is necessary').exists(),
        body('*.VehicleTypeId', 'VehicleTypeId is necessary').exists(),
        ...
        connection.query('CALL kanta_charge_Process(?)', [JSON.stringify(req.body)], function (err, results, fields) {
            if (err) {
                res.status(500).json({
