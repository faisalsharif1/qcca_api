...
module.exports = (function () {
    ...
    router.post('/api/items', [body().isArray(),
        body('*.Id', 'Id is necessary').exists(),
        body('*.ItemName', 'ItemName is necessary').exists(),
        ...
        connection.query('CALL items_Process(?)', [JSON.stringify(req.body)], function (err, results, fields) {
            if (err) {
                res.status(500).json({
