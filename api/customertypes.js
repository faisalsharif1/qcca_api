...
module.exports = (function () {
    ...
    router.post('/api/customerTypes', [body().isArray(),
        body('*.Id', 'Id is necessary').exists(),
        body('*.CustomerType', 'CustomerType is necessary').exists(),
        ...
        connection.query('CALL customertypes_Process(?)', [JSON.stringify(req.body)], function (err, results, fields) {
            if (err) {
                res.status(500).json({
