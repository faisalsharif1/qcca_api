...
module.exports = (function () {
    ...
    router.post('/api/serials', [body().isArray(),
        body('*.Id', 'Id is necessary').exists(),
        body('*.KantaId', 'KantaId is necessary').exists(),
        ...
        connection.query('CALL serials_Process(?)', [JSON.stringify(req.body)], function (err, results, fields) {
            if (err) {
                res.status(500).json({
